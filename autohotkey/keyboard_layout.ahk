...
CapsLock & n::
    KeyWait, CapsLock
    PostMessage 0x50, 0, DllCall("LoadKeyboardLayout", "Str", "00000409", "Int", 1),, A
    return

; Change keyboard layout to Korean and turn on the IME
CapsLock & ,::
    KeyWait, CapsLock
    PostMessage 0x50, 0, DllCall("LoadKeyboardLayout", "Str", "00000412", "Int", 1),, A
    ime_on := is_ime_on()
    if (ime_on = 0)
        Send {vk15sc138}
    return
...
CapsLock & .::
    KeyWait, CapsLock
    PostMessage 0x50, 0, DllCall("LoadKeyboardLayout", "Str", "00000411", "Int", 1),, A
    ime_on := is_ime_on()
    if (ime_on = 0)
